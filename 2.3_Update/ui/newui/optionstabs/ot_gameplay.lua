...
OPTION_GAMEPLAY_DIFFICULTY = Option_LabeledSlider("DIFFICULTY", "MISSION DIFFICULTY SCALE", "lblDifficulty", "MISSION DIFFICULTY SCALE", "m_sbarDifficulty", "ADJUST MISSION DIFFICULTY SCALE. EASY IS 0, STANDARD IS 1, HARD IS 2, EXPERT IS 3. MUST RESTART MISSION TO TAKE EFFECT.", 1, 1, 0.0, 3.0, [[UI_AnchorSetScale('PlayersPatch_MissionDifficultyScale', %spos, 1);]])
