...
RefStanceOrderSetting = GetStanceOrderSetting()
RefTacticalOverlaySetting = GetTacticalOverlaySetting()
RefProductionTimeSetting = GetProductionTimeSetting()
...
UI_AnchorSetScale('PlayersPatch_StanceOrderSetting', RefStanceOrderSetting, 1);
UI_AnchorSetScale('PlayersPatch_TacticalOverlaySetting', RefTacticalOverlaySetting, 1);
UI_AnchorSetScale('PlayersPatch_ProductionTimeSetting', RefProductionTimeSetting, 1);
...
FE_UI_STANCEORDER = {
	...
	},
	{
		type = "DropDownListBox",	
		name = "m_showtime",
		selected = RefStanceOrderSetting - 1,
		...
		helpTip = "Change the order of the Stance Buttons. Default is Homeworld Remastered. Must relaunch Homeworld to take effect.",
		...
		ListBox = {
			...
			-- 1
			{
				...
				Text = {
					...
					text = "$4803", --Homeworld Remastered
				},
				onMouseClicked = "UI_AnchorSetScale('PlayersPatch_StanceOrderSetting', 1.0, 1)";
			},
			-- 2
			{
				type = "TextListBoxItem",
				...
				Text = {
					textStyle = "FEListBoxItemTextStyle",
					text = "$3063", --Homeworld Classic
				},	
				onMouseClicked = "UI_AnchorSetScale('PlayersPatch_StanceOrderSetting', 2.0, 1)";
			},
		},
	},
}
...
FE_UI_TACTICAL = {
	...
	},
	{
		type = "DropDownListBox",	
		name = "m_tactical",
		selected = RefTacticalOverlaySetting - 1,
...
FE_UI_SHOWPRODTIME = {
	...
	},
	{
		type = "DropDownListBox",	
		name = "m_showtime",
		selected = RefProductionTimeSetting - 1,
		...
		helpTipTextLabel = "helpTip",
		helpTip = "Show the Base Build/Research Production Times. Default is No. Must restart game to take effect.",
...
FE_UIOPTION_TAB = {
					...
					
	{
		...
		FE_UI_BRL_HUDSCALE, --#13 in frame
...
--Sets the initial value/position for the expanded slider options. The number in the second brack must be it's location in the frame above.
FE_UIOPTION_TAB[1][13][2][1].Text.text = RefBuildResearchLaunchPanelsScale --initial value in the label
FE_UIOPTION_TAB[1][13][2][2].scrollPosition = RefBuildResearchLaunchPanelsScale --initial position for the scrollbar
