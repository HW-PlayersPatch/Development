...
OPTION_GAMEPLAY_DIFFICULTY = Option_LabeledSlider("DIFFICULTY", "MISSION DIFFICULTY SCALE", "lblDifficulty", "MISSION DIFFICULTY SCALE", "m_sbarDifficulty", "ADJUST MISSION DIFFICULTY SCALE. 0-0.9 EASIER, STANDARD IS 1, 1.1-2 HARDER. MUST RESTART MISSION TO TAKE EFFECT.", 1, 1, 0.0, 2.0, [[UI_AnchorSetScale('PlayersPatch_MissionDifficultyScale', %spos, 1);]])
