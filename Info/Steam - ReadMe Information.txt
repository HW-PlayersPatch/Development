...
[h1]Additional Gameplay and UI Options[/h1]
...
[b]1.[/b] Vast unit caps: This is double the size of Huge, and only recommended for very fast machines.
[b]2.[/b] Camera Pan Speed scale: Adjust/increase the camera speed to move around maps faster with the arrow keys and edge of screen mouse pan. Homeworld must be relaunched for changes to take affect.
[b]3.[/b] Camera Max Zoom scale: Adjust/increase the maximum distance the camera can zoom out before having to use the sensors manager. Homeworld must be relaunched for changes to take affect.
[b]4.[/b] Mission Difficulty scale: At the start of each campaign mission, extra enemy reinforcement ships and RU are added based on your fleet size and RU. This dynamic scaling difficulty can now be adjusted. Use 0 for no reinforcements, 0.1-0.9 for less reinforcements, and 1.1-3.0 for more reinforcements. Easy is 0, Normal is 1, Hard is 2 (double the difficulty), Expert is 3 (triple the difficulty). The mission must be restarted to take effect.
...
[b]5.[/b] Build, Research, and Launch Panel scale: Adjust the size of the Build/Research/Launch menus. The game must be restarted for changes to take effect. Previously these were adjustable, but their size was not saved across games.
...
Balance: Cloaked, Kadeshi, omniconsumer, Fear, and everyone else who helped with balance testing
Improvements & Bug Fixes: Cloaked, Trebic, NoOne, Lone Wolf, Dom2, Dwarfinator, 178thBattleGroup, and CryCoh
...
When the 2.0/2.1 patches were released in June 2016 the changes were simply massive. Balance issues that were missed in testing were quickly identified by the community. I identified solutions for these balance issues and provided them to Gearbox to implement in the Patch Previews.
