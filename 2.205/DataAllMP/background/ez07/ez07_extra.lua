...
sun = 
{
    ...
    rayExposure = 0.835,    -- Per ray we have to average all of the pixels we touch, this scales the final value - affecting where god rays tend to over-brighten the background.
...
ship_gamma =
{
	gammaCurves = { 0.653625, 0.653625, 0.653625 }, -- ship gamma
...
bloom =
{
	...
	inMax = { 0.55, 1.1, 1.4 },
	outMin = { 0.55, 0.95, 0.843 }, -- Mask, Curve, Scale
	outMax = { 0.55, 0.95, 0.843 },
