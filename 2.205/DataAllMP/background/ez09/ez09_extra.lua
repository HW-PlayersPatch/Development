...
sun = 
{
    position = { -4, 450, -5700 },
		follow = "Flare_Key",
    rayBoost = 1.11,    -- AFTER the god rays math has been done and bound to 'brighter than base pixel' - we mult the difference by this, and add.
...
ship_gamma =
{
	gammaCurves = { 0.6853625, 0.6853625, 0.6853625 }, -- ship gamma
	gammaScale = 1.21 -- bloom headroom
}
...
bloom =
{
	...
	inMin = { 0.85, 1.1, 1.2 }, -- Thresh, Boost, Curve
	inMax = { 0.85, 1.1, 1.4 },
...
{
    global_scale = { 0, 0, 0 },
    delta_scale = { 0.00005, 0.00005, 0.00005 },
    delta_radius = 3,
    delta_curve = 1,
}