...
sun = 
{
    position = { 813.383, 636.092, -7668.021 }, 
    rayBoost = 1.141,    -- AFTER the god rays math has been done and bound to 'brighter than base pixel' - we mult the difference by this, and add.
