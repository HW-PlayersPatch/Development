...
sun = 
{
    ...
    rayDensity = 0.71,    -- The 'distance' towards the center, as a percentage, that a ray will go from it's original spot on screen.  This effectively controls the max length of rays - lower numbers are less GPU intensive for many reasons.
...
ship_gamma =
{
	...
	gammaScale = 1.25 -- bloom headroom
}
bloom =
{
	lumiMin = { 0.299, 0.587, 0.114 },	-- RGB to Lumi
	lumiMax = { 0.299, 0.587, 0.114 },
	inMin = { .7, 1.1, 1.2 }, -- Thresh, Boost, Curve
	inMax = { .7, 1.1, 1.4 },
	outMin = { 1, 0.95, 0.843 }, -- Mask, Curve, Scale
	outMax = { 1, 0.95, 0.843 },
...
{
    global_scale = { 0, 0, 0 },
    delta_scale = { -0.000015, -0.000015, -0.000015 },
    delta_radius = 3,
    delta_curve = 1,
}
env =
