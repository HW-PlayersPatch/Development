...
sun =
{
    position = { 57.2291, 13.5857, -69.4631 },
                follow = "Flare_Key",
    rayBoost = 1.41,    -- AFTER the god rays math has been done and bound to 'brighter than base pixel' - we mult the difference by this, and add.
...
ship_gamma =
{
                ...
                gammaScale = 1.82 -- bloom headroom
}
